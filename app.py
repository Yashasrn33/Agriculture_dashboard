...
##            temperature, humidity = weather_fetch(city)
        ...
        return render_template('crop.html', p_result=final_prediction, username=username)
##        else:
##            return render_template('crop.html', msg="Some thing went wrong, try again")

    return render_template('crop.html', username=username)
...
def market():
    ...
    if table:
        result = [['AMC Market','Commodity', 'Variety', 'Maximum Price',	'Average Price', 'Minimum Price', 'Last Updated On']]
